import { InjectKysely } from '@gazer/server/kysely';
import { OgmaLogger, OgmaService } from '@ogma/nestjs-module';
import * as fs from 'fs/promises';
import { FileMigrationProvider, Kysely, Migrator, MigrationResultSet } from 'kysely';
...
export class MigrateCommand extends CommandRunner {
  constructor(
    ...
    @OgmaLogger(MigrateCommand) private readonly logger: OgmaService
  ) {
    super();
  }
